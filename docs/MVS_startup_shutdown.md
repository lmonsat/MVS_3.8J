...
### This demonstration will show how you can start the MVS OS with a console x3285 and TSO.
...
<div align="center"><img src="../assets/imgs/Hercules_console_start.png" alt="hercules_console_start" width="85%"/></div>

---

# Part 2: Launching 3285 Terminal Emulators

To interact with the MVS operating system console and log into TSO, IBM 3285 terminal emulator sessions (`x3285`) must be launched and connected to Hercules over Telnet on port `3285`.
...
<div align="center"><img src="../assets/imgs/x3270_start_console_tso_cmd.png" alt="x3270_start_console_tso_cmd" width="85%"/></div>
...
<div align="center"><img src="../assets/imgs/x3270_main_interface.png" alt="x3270_main_interface" width="85%"/></div>
...
<div align="center"><img src="../assets/imgs/x3270_console_r_start.png" alt="x3270_console_r_start" width="85%"/></div>
...
<div align="center"><img src="../assets/imgs/x3270_console_r_start_2.png" alt="x3270_console_r_start_2" width="85%"/></div>
...
<div align="center"><img src="../assets/imgs/x3270_console_start_r_noreq.png" alt="x3270_console_start_r_noreq" width="85%"/></div>
...
<div align="center"><img src="../assets/imgs/x3270_console_launch_tso.png" alt="x3270_console_launch_tso" width="85%"/></div>
...
<div align="center"><img src="../assets/imgs/x3270_tso_login_interface.png" alt="x3270_tso_login_interface" width="85%"/></div>
...
<div align="center"><img src="../assets/imgs/x3270_tso_login.png" alt="x3270_tso_login" width="85%"/></div>
...
<div align="center"><img src="../assets/imgs/x3270_tso_launch_rpf.png" alt="x3270_tso_launch_rpf" width="85%"/></div>
...
<div align="center"><img src="../assets/imgs/x3270_tso_rpf_main_menu.png" alt="x3270_tso_rpf_main_menu" width="85%"/></div>
...
<div align="center"><img src="../assets/imgs/x3270_tso_logoff.png" alt="x3270_tso_logoff" width="85%"/></div>
...
<div align="center"><img src="../assets/imgs/x3270_console_exit_tso.png" alt="x3270_console_exit_tso" width="85%"/></div>
...
<div align="center"><img src="../assets/imgs/x3270_console_exit_tso_1.png" alt="x3270_console_exit_tso_1" width="85%"/></div>
...
<div align="center"><img src="../assets/imgs/x3270_console_exit_tso_2.png" alt="x3270_console_exit_tso_2" width="85%"/></div>
...
<div align="center"><img src="../assets/imgs/x3270_console_exit_tso_3.png" alt="x3270_console_exit_tso_3" width="85%"/></div>
...
<div align="center"><img src="../assets/imgs/x3270_console_exit_tso_4.png" alt="x3270_console_exit_tso_4" width="85%"/></div>
...
<div align="center"><img src="../assets/imgs/Hercules_console_quit.png" alt="Hercules_console_quit" width="85%"/></div>
